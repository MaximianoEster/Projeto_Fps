...
public class @PlayerControls : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Player"",
            ""id"": ""a7503387-62cd-41e2-b52b-6e95c1357c0b"",
            ""actions"": [
                {
                    ""name"": ""Locomotion"",
                    ""type"": ""PassThrough"",
                    ""id"": ""cb89b12e-5900-4381-bf65-03b2d11c98df"",
                ...
                },
                {
                    ""name"": ""Interaction"",
                    ""type"": ""Button"",
                    ""id"": ""ebb75e80-8d35-4ce4-8427-aeb504ca7e70"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""dd2b98e3-7381-4bad-9a73-2a3bcd1ce188"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Look"",
                    ""type"": ""Value"",
                    ""id"": ""f18fc0a4-acec-4ded-a434-525ca515f67f"",
                    ""expectedControlType"": ""Vector2"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Attacking"",
                    ""type"": ""Button"",
                    ""id"": ""80555c33-d6d0-4b92-a1c3-ca8fe6be7fbd"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Aim"",
                    ""type"": ""Button"",
                    ""id"": ""28b7845a-b1d7-4a19-9378-fa5bb4849ec6"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                },
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""5270417d-01ab-4183-ab73-a3d3ac7c8ce0"",
                    ""path"": ""<Keyboard>/e"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""80705818-ce5f-41d3-b55e-0971a5f72d60"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""2b946ab0-f332-4d04-bb26-3c703494c6f0"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""WASD"",
                    ""id"": ""1f85fe63-d5f7-4507-a0ec-678491f7d1d0"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""8cfdc9ae-d027-46ac-8222-70fc9556a233"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""c213a03f-2cda-4ba9-997f-21a97917f1a5"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""434c0470-7ad1-4bc7-8393-b1cb9fb8d42d"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""52a10369-9356-4262-b180-85f7ddf594d1"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""7b083ea1-3705-4747-b176-4adc41726769"",
                ...
                {
                    ""name"": """",
                    ""id"": ""0e92ffa2-f708-4bfb-9a1e-4508db5065aa"",
